...
namespace Unity.TestHarness.Web.Models
{
    ...
    /// <see cref="Infrastructure.SessionLog"/>). A near-identical port of
    /// Unity.TestHarness (the WPF version)'s own LogEntry.
    /// [Serializable] isn't strictly required under InProc session mode, but costs
    /// nothing and keeps this portable if the session mode ever changes.
    /// </summary>
    [Serializable]
