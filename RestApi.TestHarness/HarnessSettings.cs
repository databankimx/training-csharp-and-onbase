...
namespace RestApi.TestHarness
{
    ...
    /*
     * *Migration Note: identical to Unity.TestHarness's own HarnessSettings. The
     * ConfigurationManager API surface used here is the same on net10.0 (via the
     * System.Configuration.ConfigurationManager NuGet package, referenced in this
     * project's .csproj) as it was implicitly on Unity.TestHarness's own net48, no
