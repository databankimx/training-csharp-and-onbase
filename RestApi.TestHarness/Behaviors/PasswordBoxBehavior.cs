...
namespace RestApi.TestHarness.Behaviors
{
    #region Training Notes
    /*
     * *Migration Note: identical to Unity.TestHarness's own PasswordBoxBehavior, purely
     * generic WPF infrastructure with no Unity API/REST API dependency at all.
     */
    #endregion
