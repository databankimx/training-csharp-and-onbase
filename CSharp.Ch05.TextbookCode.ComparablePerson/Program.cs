 ...
 *
 * Interactive WinForms lab: a Person class implementing IComparable<Person> by full
 *     name, showing an unsorted list next to the same list after Array.Sort(). No bugs
